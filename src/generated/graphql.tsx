...
export type LanuchesQueryVariables = Exact<{ [key: string]: never; }>;


export type LanuchesQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'details' | 'launch_year' | 'launch_success' | 'launch_date_local' | 'mission_name' | 'mission_id'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export type RocketsQuery = (
  ...
  & { rockets?: Maybe<Array<Maybe<(
    { __typename?: 'Rocket' }
    & Pick<Rocket, 'company' | 'cost_per_launch' | 'country' | 'description' | 'first_flight' | 'id'>
    & { diameter?: Maybe<(
      { __typename?: 'Dimension' }
      & Pick<Dimension, 'feet' | 'meters'>
    )>, engines?: Maybe<(
      { __typename?: 'Engines' }
...
export const LanuchesDocument = gql`
    query lanuches {
  launches {
    details
    launch_year
...
/**
 * __useLanuchesQuery__
 *
 * To run a query within a React component, call `useLanuchesQuery` and pass it any options that fit your needs.
 * When your component renders, `useLanuchesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLanuchesQuery({
 *   variables: {
 *   },
 * });
 */
export function useLanuchesQuery(baseOptions?: Apollo.QueryHookOptions<LanuchesQuery, LanuchesQueryVariables>) {
        return Apollo.useQuery<LanuchesQuery, LanuchesQueryVariables>(LanuchesDocument, baseOptions);
      }
export function useLanuchesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LanuchesQuery, LanuchesQueryVariables>) {
          return Apollo.useLazyQuery<LanuchesQuery, LanuchesQueryVariables>(LanuchesDocument, baseOptions);
        }
export type LanuchesQueryHookResult = ReturnType<typeof useLanuchesQuery>;
export type LanuchesLazyQueryHookResult = ReturnType<typeof useLanuchesLazyQuery>;
export type LanuchesQueryResult = Apollo.QueryResult<LanuchesQuery, LanuchesQueryVariables>;
